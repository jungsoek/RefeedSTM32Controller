...
#include "Calibration.h"   // CAL_Init, CAL_* 함수들
...
/* Last added mass from [CAL]XX# */
static float g_cal_last_added_mass = 0.0f;

/* HX711 handles must be global (used by calibration) */
HX711_t scale1;
HX711_t scale2;
